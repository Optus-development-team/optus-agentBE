  ...
  async replyWithMedia(
    ...
    switch (mediaType) {
      case MessageType.IMAGE:
        return this.messagingService.sendImage(
          this.senderId,
          { link: mediaUrl },
          opts,
        );
      case MessageType.VIDEO:
        return this.messagingService.sendVideo(
          this.senderId,
          { link: mediaUrl },
          opts,
        );
      case MessageType.DOCUMENT:
        return this.messagingService.sendDocument(
          this.senderId,
          { link: mediaUrl },
          opts,
        );
      case MessageType.AUDIO:
        return this.messagingService.sendAudio(
          this.senderId,
          { link: mediaUrl },
          opts,
        );
      default:
        throw new Error(
          `Media type ${mediaType} not natively supported for inline quick reply yet.`,
        );
    }
  }
