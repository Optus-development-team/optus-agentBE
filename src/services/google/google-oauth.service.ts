/**
 * Servicio de OAuth de Google para integraciones de calendario.
 *
 * Responsabilidades:
 * - Generar URLs de consentimiento OAuth
 * - Intercambiar códigos por tokens
 * - Gestionar refresh tokens
 *
 * @moved-from src/whatsapp/services/google-oauth.service.ts
 */
